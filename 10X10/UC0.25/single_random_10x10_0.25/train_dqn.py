...
def load_models():
      ...
      agent_d.online_network.load_state_dict(torch.load("models/drone_online30000.pth"))
      agent_d.target_network.load_state_dict(torch.load("models/drone_target30000.pth"))      
      agent_r.online_network.load_state_dict(torch.load("models/ranger_online30000.pth"))      
      agent_r.target_network.load_state_dict(torch.load("models/ranger_target30000.pth"))
