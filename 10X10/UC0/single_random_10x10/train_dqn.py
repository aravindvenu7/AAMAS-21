...
def load_models():
      ...
      agent_d.online_network.load_state_dict(torch.load("models/drone_online50000.pth"))
      agent_d.target_network.load_state_dict(torch.load("models/drone_target50000.pth"))      
      agent_r.online_network.load_state_dict(torch.load("models/ranger_online50000.pth"))      
      agent_r.target_network.load_state_dict(torch.load("models/ranger_target50000.pth"))
